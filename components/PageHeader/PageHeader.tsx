...
export const PageHeader: React.FC<{ imgSrc: string, imgPosition?: number, title: string }> = ({ imgSrc, imgPosition = 0, title }) => {
  return (
    <div className="relative overflow-hidden h-[280px]">
      ...
      <div className="absolute w-0 h-0 bottom-0 border-b-[50px] border-r-[100vw] border-transparent border-b-white" />

      <h1 className="text-5xl text-medium text-center mt-24 text-white drop-shadow">
        {title}
      </h1>
    </div>
