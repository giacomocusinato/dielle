...
export const SVGLogo = () => {
  ...
  return (
    <svg id="svg"
      className={classNames('pr-2 sm:pr-4 w-[140px] sm:w-[220px] lg:w-[260px] overflow-visible fill-white', styles.svg)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 517.23 526.59">
      <title>DIELLE</title>
